...
fn parse_imported_rule_lines(rules_text: &str) -> Result<Vec<String>, HMetaError> {
...
fn imported_rule_yaml_sequence(value: &Value) -> Result<Vec<String>, HMetaError> {
    match value {
...
fn imported_rule_values(values: &[Value]) -> Result<Vec<String>, HMetaError> {
    values
        .iter()
        .enumerate()
        .map(|(index, value)| {
...
fn imported_rule_text_lines(content: &str) -> Vec<String> {
    content
        .lines()
...
fn validate_imported_rule_line(rule: &str, index: usize) -> Result<(), HMetaError> {
